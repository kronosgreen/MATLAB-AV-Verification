function [ep, facing, inPoint, lanes, pieces] = multiLaneRoad(drScn, inPoint, ep, facing, pieces, curLanes, lanes, egoLane, length, bidirectional, midTurnLane, speedLimit, roadSlickness, angle)
