classdef (StrictDefaults)ScenarioReader < matlab.System ...
...
%#codegen
    ...
    methods(Access = protected)
        ...
        function flag = isInactivePropertyImpl(obj,prop)
            ...
            flag = isInactivePropertyImpl@matlab.System(obj,prop);
        ...
        function [out, varargout] = getOutputDataTypeImpl(obj)
            ...
            [out,busTypeLaneBoundaries,busTypeLaneMarkings] = getOutputDataTypeImpl@matlab.System(obj);
    ...
    methods(Static, Access = protected)
        ...
        function groups = getPropertyGroupsImpl
            ...
            busUtil = getPropertyGroupsImpl@matlab.System;
